...
namespace Bau.Libraries.LibHelper.Files
{
	...
	public class HelperFiles
	{
		...
		///		Abre una aplicación
		/// </summary>
		public static void Execute(string strFileName, string strArguments, bool blnShowWindow)
		{ Process objProcess = new Process();
				...
				// Inicializa las propiedades del proceso
					...
					objProcess.StartInfo.RedirectStandardOutput = false;
					objProcess.StartInfo.WindowStyle = ProcessWindowStyle.Normal;
					objProcess.StartInfo.CreateNoWindow = !blnShowWindow;
				// Asigna el nombre de archivo y los argumentos
					objProcess.StartInfo.FileName = strFileName;
